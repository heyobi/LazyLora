...
first three steps is about 7.4 h (7.26 h, 7.62 h, 7.37 h between them), so a hundred steps is about
...
100 steps at the measured about 7.4 h cadence is about 31 days — and the evaluation runs after it. Nothing
